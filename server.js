...
app.use(
  cors({
    origin: ["http://localhost:3000","http://localhost:3001", "https://alumni-frontend-4ca1.vercel.app","https://alumni-p-eps.vercel.app","https://api.excelpublicschool.com","https://api.excelpublicschool.com/alumni/login","https://api.excelpublicschool.com/settings/","https://alumni.excelpublicschool.com","https://alumnify.in"],
    credentials: true,
  })
);
//app.use(cors());
