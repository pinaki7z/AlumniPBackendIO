...
const businessConnectRoutes = require("./routes/businessConnectRoutes");
const sponsorshipv2Routes = require("./routes/sponsorshipv2Routes");
const newsRoutesV2 = require("./routes/newsRoutesV2");
const prohibitedKeywordsRoutes = require("./routes/prohibitedKeywordsRoutes");
...
app.use("/api/business", businessConnectRoutes);
app.use('/api/sponsorship', sponsorshipv2Routes);
app.use('/api/news', newsRoutesV2);
app.use("/api/prohibited-keywords", prohibitedKeywordsRoutes);
