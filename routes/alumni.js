...
alumniRoutes.get("/all", async (req, res) => {
  try {
    const alumni = await Alumni.find()
      .select(
        "firstName lastName profilePicture profileLevel _id email workExperience accountDeleted graduatingYear class groupNames linkedIn department batch aboutMe followers following country city"
      )
      .lean();
    if (!alumni.length) {
